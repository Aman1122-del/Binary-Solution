...
<body>
                        ...
                        <div class="course-item d-flex">
                            <div class="course-inner">
                                <div class="course-img">
                                    <img style="height: 11rem; width:100%;" src="{{ asset($solution->preview_image) }}"
                                        alt="course">
                                    <div class="course-price">$ {{ $solution->price }}</div>
                                </div>

                                <div class="course-content">
                                    <div class="ccategory">
                                        <a href="#">{{ $solution->subject_area }}</a>
                                    </div>

                                    <h3><a href="#">{{ $solution->title }}</a></h3>

                                    <div>
                                        <h5 style="font-weight: lighter">{{ $solution->course_name }}</h5>
                                    </div>
                                    <div>
                                        <p class="mb-1">{{ $solution->universty_name }}</p>
                                        <div>
                                    ...
                                    <div class="cmeta">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.1 -->
                                                <path fill="#FFD43B"
                                            ...
                                            {{ $solution->updated_at->format('d M Y') }}
                                        </span>
                            ...
                            <div class="course-hover align-self-center">
                                <div class="chover_content">
                                    ...
                                    <div class="hcourse-price">$ {{ $solution->price }}</div>
                                    <p class="desc">
                                    ...
                                    <div class="dropdown-features">
                                        ...
                                        <div class="dropdown-body show" style="display:block; margin-top:10px;">
                                            ...
                                            {{-- Tutorial Session --}}
                                            <div class="feature-item d-flex align-items-center mb-1">
                                                @if ($solution->has_tutorial_session)
                                                    <i class="fa fa-check text-success me-2"></i>
                                                @else
                                                    <i class="fa fa-times text-danger me-2"></i>
                                                @endif
                                            ...
                                            {{-- Download Limit --}}
                                            <div class="feature-item d-flex align-items-center mb-1">
                                                @if (!is_null($solution->download_limit))
                                                    <i class="fa fa-check text-success me-2"></i>
                                                    <span>Download Limit: {{ $solution->download_limit }}</span>
                                                @else
                                                    <i class="fa fa-times text-danger me-2"></i>
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('solution.detail', ['solution_id' => $solution->id]) }}" class="bg-btn">Get Solution <i
  ...
  const MAX = 100; // truncate limit

  document.querySelectorAll(".desc").forEach(function(p) {
    let text = p.textContent.trim();
    if (text.length > MAX) {
      p.textContent = text.substring(0, MAX) + "...";
    }
  });
});
    </script>
